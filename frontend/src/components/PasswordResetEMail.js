...
class PasswordResetEMail extends React.Component {
	...
	render() {
		...
		return <Grid container spacing={16}>
			...
			<Grid item xs={12}>
				<TextField
					label={config.uiTexts.PasswordResetEMail.email}
			...
			<Grid item xs={12}>
				...
				>
					{config.uiTexts.PasswordResetEMail.sendConfirmation}
				</Button>
			</Grid>
			<Grid item xs={12}>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(PasswordResetEMail));
